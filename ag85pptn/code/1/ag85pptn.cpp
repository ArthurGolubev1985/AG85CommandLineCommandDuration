...
int main(int argc, char * argv[]) {
	...
	try {
        ...
        Uptoinnanosecondstimer wrappedProgramPerformingUptoinnannosecondstimer;
        ...
        wrappedProgramPerformingUptoinnannosecondstimer.Run();

        int res = std::system(commandToPerform.c_str());

        wrappedProgramPerformingUptoinnannosecondstimer.Pause();
